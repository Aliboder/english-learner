    ...
    <div class="w-120 color-main">
      ...
      <div class="space-y-4">
        ...
        <div class="flex items-center gap-space">
          ...
          <BaseButton type="info" @click="applyRecentRange(500)">{{ '最近 500 个' }}</BaseButton>
          <BaseButton type="info" @click="applyRecentRange(300)">{{ '最近 300 个' }}</BaseButton>
          <BaseButton type="info" @click="applyRecentRange(100)">{{ '最近 100 个' }}</BaseButton>
        </div>
      </div>
    </div>
  </Dialog>
